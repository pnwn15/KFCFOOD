...
function Team() {
  return (
      <div class="font-sans">
            <div class="lg:max-w-5xl max-w-3xl mt-10 mx-auto">
                <div class="max-w-2xl mx-auto text-center">
                    <h2 class="text-gray-800 text-5xl font-extrabold">Our satisfied customer says</h2>
                    <p class="text-gray-800 text-sm mt-4 leading-relaxed">Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts. Separated they live in</p>
                </div>
                ...
                <div class="grid lg:grid-cols-4 md:grid-cols-3 gap-6 max-md:justify-center mt-12">
                    <div class="border rounded-lg overflow-hidden">
                        ...
                        <div class="p-4">
                            ...
                            <p class="text-gray-800 text-xs mt-1">Fullstackdeveloper</p>
                    ...
                    <div class="border rounded-lg overflow-hidden">
                        ...
                        <div class="p-4">
                            ...
                            <p class="text-gray-800 text-xs mt-1">Cat</p>
                    ...
                    <div class="border rounded-lg overflow-hidden">
                        ...
                        <div class="p-4">
                            ...
                            <p class="text-gray-800 text-xs mt-1">Figma</p>
                    ...
                    <div class="border rounded-lg overflow-hidden">
                        ...
                        <div class="p-4">
                            ...
                            <p class="text-gray-800 text-xs mt-1">Play game 24 hr</p>
